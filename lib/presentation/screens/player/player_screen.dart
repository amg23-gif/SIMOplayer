          ...
          body: GestureDetector(
            ...
            child: Stack(
              children: [
                ...
                // ── Video ────────────────────────────────────────
                Positioned.fill(child: _VideoView(state: ps)),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (ps.currentChannel?.category.isNotEmpty == true)
                                  Text(ps.currentChannel!.category,
                                    style: const TextStyle(
                                      fontFamily: 'Cairo', color: Color(0xFF4D8EFF),
                                      fontSize: 10,
                ...
                if (ps.showControls &&
                  ...
                  Positioned.fill(
                    child: _ControlsOverlay(
                      state: ps,
                      onChannelList: _togglePanel,
                    ),
                  ),

                // ── Loading ──────────────────────────────────────
                if (ps.status == PlayerStatus.loading ||
                    ps.status == PlayerStatus.switching)
                  Center(
                  ...
                  child: Row(children: [
                    ...
                    if (widget.currentCategory.isNotEmpty)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFF1E6CF5).withOpacity(0.15),
                          borderRadius: BorderRadius.circular(6),
                          border: Border.all(color: const Color(0xFF1E6CF5).withOpacity(0.3)),
                        ),
                        child: Text(widget.currentCategory,
                          style: const TextStyle(fontFamily: 'Cairo',
                            color: Color(0xFF4D8EFF), fontSize: 9)),
                      ),
                  ]),
                ),
              ),
              ...
              Expanded(
                child: channelsAsync.when(
                  ...
                  error: (_, __) => const Center(
                    child: Text('خطأ', style: TextStyle(fontFamily: 'Cairo', color: Color(0xFF4A5568)))),
                  data: (all) {
                    ...
                    if (_search.isNotEmpty) {
                      channels = channels.where((c) =>
                        c.name.toLowerCase().contains(_search)).toList();
                    }
                    if (channels.isEmpty) {
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(8),
                              border: isCurrent
                                  ? Border.all(color: const Color(0xFF1E6CF5).withOpacity(0.4))
                                  : null,
                            ),
                            child: Row(children: [
                              SizedBox(
                                ...
                                child: ch.logoUrl != null && ch.logoUrl!.isNotEmpty
                                    ? CachedNetworkImage(
                                        ...
                                        errorWidget: (_, __, ___) => Icon(
                                          ...
                                          color: const Color(0xFF1C2540), size: 16))
    ...
    Widget build(BuildContext context) => GestureDetector(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(label, style: const TextStyle(fontFamily: 'Cairo', color: Colors.white, fontSize: 12)),
        ]),
      ),
    );
  }
